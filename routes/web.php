...
Route::get('/user/{id}/enable/{type}', 'UserController@enable')->name('user.enable');
Route::get('/user/{id}/disable/{type}', 'UserController@disable')->name('user.disable');
...
Route::get('/court/delete/{id}', 'CourtController@delete')->name('court.delete');
...
Route::post('/event/create', 'EventController@createPost')->name('event.create');
Route::get('/event/{id}', 'EventController@event')->name('event.event');
Route::post('/event/{id}', 'EventController@eventPost')->name('event.event');
...
Route::post('/event/event_price/create/{id}', 'EventPriceController@createPost')->name('event_price.create');
Route::get('/event/event_price/{id}', 'EventPriceController@eventPrice')->name('event_price.event_price');
Route::post('/event/event_price/{id}', 'EventPriceController@eventPricePost')->name('event_price.event_price');
